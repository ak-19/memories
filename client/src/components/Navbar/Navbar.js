    ...
    return (
        <AppBar className="appBar" position="static" color="inherit">
            <div className="brandContainer">
                <Typography component={Link} to="/" className="heading" variant="h2" align="center"> My stories </Typography>
            ...
            <Toolbar className="toolbar">
                {user
                    ...
                    :
                    (
                        <Button component={Link} to="/auth" className="login" color="primary">Login</Button>
                    )
                }
            </Toolbar>
        </AppBar>
